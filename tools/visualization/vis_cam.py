...
def parse_args():
    ...
    parser.add_argument('--img', default="home/zys/wnmd/fuck/images/A/" ,help='Image file')
    parser.add_argument('--config',default="configs/Mynet/my3.py", help='train config file path')
    parser.add_argument('--checkpoint',default="work_dirs/fuck/bb.pth", help='checkpoint file')
    parser.add_argument(
        '--target-layers',
        default=[],
        nargs='+',
    ...
    parser.add_argument(
        '--save-path',
        default="/home/zys/wnmd/fuck/images/fuck/res",
        type=Path,
        help='The path to save visualize cam image, default not to save.')
    parser.add_argument('--device', default='cuda:1', help='Device to use cpu')
    parser.add_argument(
        '--vit-like',
        action='store_true',
