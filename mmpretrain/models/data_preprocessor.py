...
def stack_batch2(inputs: List[torch.Tensor],
...
class DualInputCaptionDataPreProcessor(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> Dict[str, Any]:
        ...
        if training:
            ...
            inputs, data_samples = stack_batch2(
                inputs=inputs,
            ...
            if self.test_cfg:
                inputs, padded_samples = stack_batch2(
                    inputs=inputs,
